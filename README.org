...
#+begin_src emacs-lisp
    (use-package which-key
      ...
      (which-key-paging-prefixes '("C-x" "C-c" "C-h" "C-x x"))
      (which-key-paging-key "<f8>")
      (which-key-side-window-max-height 0.65)
      :config
...
#+begin_src emacs-lisp
  (use-package theme-changer
    ...
    (change-theme 'ef-duo-light 'doom-dark+))
#+end_src
...
#+begin_src emacs-lisp
  ...
  ;; doom snippets override all other snippets dirs
  (setq yas-snippet-dirs '("/home/frederic/.emacs.d/snippets" "/home/frederic/.emacs.d/elpaca/builds/java-snippets/snippets" yasnippet-snippets-dir doom-snippets-dir))
#+end_src

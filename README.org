...
#+begin_src emacs-lisp
  ...
  See straight/versions/default.el"
    ...
    (message "Done"))
    (keymap-global-set "C-c M-p" 'straight-update-packages)
...
#+begin_src emacs-lisp
  ...
  (add-to-list 'recentf-exclude "~/org/calendar.org")
...
#+begin_src emacs-lisp
  (use-package org
    ...
    :hook ((org-mode . (lambda ()
                        (setq-local prettify-symbols-alist '((":PROPERTIES:" . "»")
                                                             )))))
    ...
    (defun my/add-insert-state-exit-save-hook()
      ...
      (add-hook 'evil-insert-state-exit-hook 'save-buffer nil t ))
...
#+begin_src emacs-lisp
  (use-package org-modern
    ...
    (setq org-modern-todo-faces
          (quote (("TODO" :background "dark orange" :foreground "black" :weight bold)
                  ("NEXT" :background "orange red" :foreground "yellow" :weight bold)
                  ("WAIT" :background "magenta" :weight bold)
                  ("HOLD" :background "magenta" :weight bold)
                  ("CANCELLED" :background "dark red" :weight bold)
                  ("KILL" :background "dark red" :weight bold)
                  ("MEETING" :background "chocolate" :weight bold)
                  )))
    (setq org-modern-block-name '(("quote" "«" "»") (t . t)))
...
#+begin_src emacs-lisp
  (use-package mu4e
    :unless my/using-android
    :straight (mu :type git :host github :repo "dgcb/mu" :branch "release/1.10")
    :demand t
    :bind (("C-x m" . mu4e))
    :custom

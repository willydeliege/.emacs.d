...
#+begin_src emacs-lisp
  (use-package which-key
    :straight (:repo "wesnel/emacs-which-key")
    :init
...
#+begin_src emacs-lisp
  ...
  `notmuch-show-view-part'."
    ...
    (setq notmuch-address-command "~/.emacs.d/gook")
    :config
    (add-to-list 'notmuch-tagging-keys '("t" ("+trash" "-inbox" "-unread") "Move to trash")))
#+end_src
*** Notmuch-indicator
#+begin_src emacs-lisp

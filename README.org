...
* Completion
** Vertico + Marginalia
gertico.el - VERTical Interactive COmpletion
...
#+begin_src emacs-lisp
  ...
  (add-to-list 'org-roam-capture-templates  '("p" "project" plain
                                              (file "~/.emacs.d/templates/project-template.org")
  ...
  (defun my/org-roam-find-project ()
    ...
    (org-roam-node-find
     ...
     nil
     :templates
     '(("p" "project" plain (file "~/.emacs.d/templates/project-template.org")
        :target (file "%<%Y%m%d%H%M%S>-${slug}.org")
        :unnarrowed t))))
...
#+begin_src emacs-lisp
  ...
  (use-package org-gcal
    :hook (org-agenda-finalize . org-gcal-sync)
    :init
...
#+begin_src emacs-lisp
  (use-package emojify
    :after company
    :init
    (setq emojify-company-tooltip-p t)
    (global-emojify-mode))
#+end_src
** Company emoji
#+begin_src emacs-lisp

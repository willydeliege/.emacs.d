...
#+begin_src emacs-lisp
  ...
  (use-package evil
    :hook (lisp-interaction-mode . my/remove-insert-state-exit-save-hook )
    :init
    ...
    (defun my/remove-insert-state-exit-save-hook()
      ...
      (remove-hook 'evil-insert-state-exit-hook 'evil-write t ))

    (defun my/add-insert-state-exit-save-hook()
      "Add save buffer wen leaving insert state."
      (add-hook 'evil-insert-state-exit-hook 'evil-write 0 t ))
    (evil-mode 1))

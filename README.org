...
#+begin_src emacs-lisp
  ...
  (defun my/org-roam-refresh-agenda-list ()
    "Set the agenda list.
  These are the project files, the calendar file and the
  weekly file"
    (interactive)
  ...
  (defun my/org-roam-archive-project ()
    ...
    (let (( id (org-entry-get 1 "ID"))
          ...
          (org-roam-dailies-capture-templates
           '(("t" "ARCHIVE" plain "**** DONE %(org-link-make-string
                            (concat id-string id)
  ...
  (defun make-archive()
    (message "test archive")
    (when (member "ARCHIVE" (org-get-tags))
      (my/org-roam-archive-project)))

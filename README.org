...
#+begin_src emacs-lisp
  (use-package meow
    ...
    :hook (meow-motion-mode . my-motion-mode-hook)
    :init
    (defun my-motion-mode-hook ()
      "Custom `meow-motion-mode' behaviours."
      (let ((keymap (make-sparse-keymap)))
        (set-keymap-parent keymap key-translation-map)
        (setq-local key-translation-map keymap)
        (define-key key-translation-map (kbd "e") (kbd "p"))
        (define-key key-translation-map (kbd "p") (kbd "e"))

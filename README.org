...
#+begin_src emacs-lisp
  ...
  (use-package consult
    ...
    (consult-customize consult--source-buffer :hidden t :default nil)
    (consult-customize consult--source-project-buffer :narrow ?p)
    (consult-customize consult--source-project-recent-file :narrow ?b)
    (define-key consult-narrow-map (vconcat consult-narrow-key "?") #'consult-narrow-help)
    (delete 'consult--source-project-buffer-hidden consult-buffer-sources)
    (delete 'consult--source-project-recent-file-hidden consult-buffer-sources)
    (add-to-list 'consult-buffer-sources 'consult--source-project-recent-file)

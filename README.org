    ...
    (org-babel-do-load-languages 'org-babel-load-languages
                                 (append org-babel-load-languages
                                         '((shell     . t)
                                           (java      . t))))
    :config
    (defun my/save-interactively ()
      "Prevent to call a file to choose.
  And not run save in special edit mode."
      (call-interactively #'evil-write))
    (defun my/remove-insert-state-exit-save-hook()
      "Remove save buffer wen leaving insert state."
      (remove-hook 'evil-insert-state-exit-hook 'my/save-interactively t ))

    (defun my/add-insert-state-exit-save-hook()
      "Add save buffer wen leaving insert state."
      (add-hook 'evil-insert-state-exit-hook 'my/save-interactively t ))
...
#+begin_src emacs-lisp
  ...
  :after org
    ...
    (setq org-modern-priority nil) ;; use fancy priorities
...
#+begin_src emacs-lisp
  (use-package evil-org
    ...
    :custom
    (evil-org-key-theme '(textobjects insert navigation additional shift todo))
    :init

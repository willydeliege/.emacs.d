;;; org-roam-logseq --- convert lofseq links 
...
(defvar bill/logseq-pages (f-expand (f-join bill/logseq-folder "")))
(defvar bill/logseq-journals (f-expand (f-join bill/logseq-folder "daily")))
